          ...
          <div className="py-6 px-6 lg:px-8">
            ...
            <form className="space-y-6" onSubmit={handleLogin}>
              ...
              <div className="flex  justify-between">
                <Link to='/' className='text-sm text-blue-700 hover:underline'>Register</Link>
                <Link to="/forgot" className="text-sm text-red-700 hover:underline">Lost Password?</Link>
              </div>
              <button type="submit"
                className="w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-full text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Sign
                In
